...
rmdir /S /Q "%tmp%\Bits"
robocopy "%bits%\world\contentdb\templates" "%tmp%\Bits\world\contentdb\templates\minibits\evil-pupod" /E
robocopy "%bits%\world\contentdb\templates-minimod" "%tmp%\Bits\world\contentdb\templates" /E
